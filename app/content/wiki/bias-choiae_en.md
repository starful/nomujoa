...
lang: en
layout: wiki
summary: '"Bias," or "최애" (choi-ae) in Korean, refers to a K-pop fan''s absolute favorite
  member within a group, or their overall favorite artist. It signifies a deep connection
  and strong personal preference.'
tags:
- K-pop
- fan culture
- bias
...
*   **Scenario 1: A conversation on Twitter**
...
*   **Scenario 2: A post on a K-pop forum**
...
*   **Scenario 3: During a fan sign event (imagined)**
...
*   **Scenario 4: Discussing album purchases with a friend**
