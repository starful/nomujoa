...
lang: en
layout: wiki
summary: 올콘 (Olkon) is a highly respected term in K-Pop fandom, signifying a fan's
  successful endeavor to attend every single performance date within a specific, consecutive
  concert or tour stop schedule. It represents the pinnacle of dedication, financial
  commitment, and ticketing prowess within the rigorous K-Pop fan community structure.
tags:
- Fandom Culture
- Concert Attendance
- Ticketing Wars
...
*   **Status Declaration:** "이번 서울콘은 내가 올콘 성공했어." (*I succeeded in achieving Olkon for this Seoul concert.*)
*   **Identification:** An "Olkon-er" or "Olkon fan" (*올콘러* / *Olkon-leo*) is a recognized category of highly committed fan.

### 3.2 Verb Usage and Related Terms

While not a formal verb, Olkon is often verbalized colloquially:

*   "나 그 콘서트 올콘 뛴다." (*I am running/attending Olkon for that concert.*) The verb 뛴다 (*ttwinda*, ‘to run/jump’) emphasizes the effort and physical commitment required.

**Related Terminologies:**

*   **첫콘 (Cheotkon):** The First Concert of the run.
*   **막콘 (Makkon):** The Last Concert (막, *Mak*, meaning ‘end’ or ‘last’). This is often the most emotionally charged show, featuring the final ments (comments) and special surprises.
*   **중콘 (Jungkon):** The Middle Concert(s). Used when the run is three days or more (e.g., Saturday show in a Fri-Sat-Sun lineup).
*   **회차 (Hoecha):** The specific 'round' or day number of the performance (e.g., 1st *hoecha*, 2nd *hoecha*). Olkon means attending every *hoecha*.
*   **지방콘 (Jibangkon):** Regional/Provincial Concerts. If a fan attends all shows across various regional stops in addition to the Seoul shows, this is sometimes referred to as 'Tour Olkon,' though the strict definition of *Olkon* usually applies only to the consecutive dates in one city.
...
*   **Credibility:** Their opinions on the concert’s quality, setlist, and the artist's performance are often given higher weight than those who attended only once.
*   **Networking:** Olkon attendance often facilitates closer relationships with other high-status fans, enabling cooperation for future ticketing efforts, merchandise pooling, and access to exclusive fan events.
*   **Sense of Belonging:** The shared struggle and success of achieving Olkon fosters a strong sense of camaraderie among the small group of fans who manage it.
...
*   **Ticket Sales:** Olkon fans guarantee the sale of multiple high-priced tickets, stabilizing the initial box office revenue for the highly competitive domestic stops.
*   **Merchandise Sales:** Because these fans attend multiple days, they are the target consumers for day-specific or random merchandise (like photocards or randomized official goods). An Olkon fan is statistically likely to spend 200-300% more on merchandise than a single-day attendee, seeking to complete sets or acquire items unique to the specific *hoecha*.
*   **Ancillary Spending:** Their spending fuels surrounding businesses—hotels, restaurants, fan café events, and external fan-made merchandise sales near the venue.
...
*   **Macro Usage:** Due to the extremely low odds of securing multiple high-demand tickets in the competitive general sale, many Olkon fans rely on sophisticated methods, including utilizing multiple accounts, joining organized ticket-buying groups (sometimes paying a commission for guaranteed success), or in controversial cases, resorting to the secondary/resale market (암표, *am-pyo*, or "dark tickets").
*   **Policy Response:** This practice has forced entertainment agencies and ticketing platforms to implement stricter anti-macro and anti-resale policies, such as mandatory on-site identification checks and the banning of transferred tickets, making the achievement of legitimate, non-premium Olkon increasingly difficult but also raising its prestige further.