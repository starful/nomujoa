...
lang: en
layout: wiki
summary: 이선좌 (I-Seon-Jwa) is a term defining the ultimate failure notification during
  highly competitive K-Pop concert ticketing, signaling that another user successfully
  processed the final step for a seat a millisecond faster. It represents the psychological
  climax and inevitable despair of the K-Pop ticketing war (피켓팅, P-Ticketing).
tags:
- KPop Ticketing
- P-Ticketing
- Concert Culture
...
- Ticketing War
- Interpark
title: Already Selected Seat (이선좌)
---
...
*   **이 (이):** This, referring to the specific seat.
*   **선 (선):** Selected (선택된).
*   **좌 (좌):** Seat (좌석).
...
이선좌 is specific because it occurs at the most advanced stage of the ticketing process, often succeeding the most difficult preceding steps:
1.  **Waiting Room/Queue Bypass:** Surviving the initial login rush.
2.  **Seat Selection:** Rapidly identifying and clicking a desirable seat on the complex seating map before others.
3.  **Payment Navigation:** Inputting essential details (e.g., phone number, email) and reaching the payment option selection.
...
*   **피켓팅 (P-Ticketing):** The overall blood-sweating ticketing war. 이선좌 is the primary casualty of P-Ticketing.
*   **광탈 (Gwang-Tal):** Instantaneous failure; usually failing in the queue or failing to select a seat at all. 이선좌 is a failure *after* Gwang-Tal has been avoided.
*   **취켓팅 (Chwi-keting):** Cancellation Ticketing. The practice of relentlessly refreshing the ticketing page during off-hours (usually 2 AM KST) to snatch seats that were initially held but later cancelled (often due to failed bank transfers or credit card declines). The possibility of snagging a ticket via Chwi-keting is the only relief after an 이선좌 failure during the main sale.
*   **무통장 (Mu-Tong-Jang):** Bank Transfer Payment. Historically, this method sometimes offered a marginal, seconds-long advantage over credit card processing, leading to intense debate among fans about which payment method minimized the risk of 이선좌.
...
*   **Interpark:** Known for rapid queue loading but highly volatile seat selection confirmation, often delivering the 이선좌 error right before final confirmation.
*   **Yes24:** Often criticized for queue stability issues, but when successfully accessed, the pressure point remains the moment of payment submission.
